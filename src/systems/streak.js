/**
 * Training streak calculator.
 *
 * - calcStreak() — current streak, longest streak, and weeks active (last 4 weeks)
 */
...
/**
 * Calculate training streak statistics from the entry log.
 *
 * A "streak" counts consecutive training days, allowing up to a 2-day gap
 * between sessions (so Mon -> Wed -> Fri still counts as a streak).
 *
