...
export const ACCESSORY_DB = {
  ...
  'sq-legpress': {
    name: 'Leg Press',
    mainLift: 'squat',
    weakPoints: ['quads', 'hole'],
    pctOfTM: 1.0,
    sets: 3,
    repRange: [8, 12],
    equipment: 'machine',
    category: 'quad-compound',
  },
  'sq-goodmorning': {
    name: 'Good Morning',
    mainLift: 'squat',
    weakPoints: ['lockout', 'core'],
    pctOfTM: 0.35,
    sets: 3,
    repRange: [8, 12],
    equipment: 'barbell',
  ...
  'bn-dbpress': {
    name: 'Dumbbell Press',
    mainLift: 'bench',
    weakPoints: ['chest', 'shoulders'],
    pctOfTM: 0.3,
    sets: 3,
    repRange: [8, 12],
    equipment: 'dumbbell',
    category: 'chest-accessory',
  },
  'bn-flies': {
    name: 'Chest Flies',
    mainLift: 'bench',
  ...
  'bn-facepull': {
    name: 'Face Pulls',
    mainLift: 'bench',
    weakPoints: ['upperback', 'shoulders'],
    pctOfTM: 0.12,
    sets: 3,
    repRange: [12, 20],
    equipment: 'cable',
  ...
  'dl-shrugs': {
    name: 'Barbell Shrugs',
    mainLift: 'deadlift',
    weakPoints: ['lockout', 'grip', 'upperback'],
    pctOfTM: 0.5,
    sets: 3,
    repRange: [8, 12],
    equipment: 'barbell',
...
export const EXERCISE_INFO = {
  ...
  'dl-frontsquat': {
    desc: 'Barbell on front delts, upright squat. Builds quad drive for breaking the floor.',
    yt: '',
  },
  'dl-legpress': {
    desc: 'Machine leg press. Quad strength for the initial pull without spinal load.',
    yt: '',
  },
  'dl-blockpull': {
  ...
  'dl-hipthrust': {
    desc: 'Back on bench, drive barbell up with hips. Glute power for hip extension at lockout.',
    yt: '',
  },
  'dl-goodmorning': {
    desc: 'Barbell on back, hinge at hips. Builds posterior chain for maintaining back position.',
    yt: '',
  },
  'dl-glutebridge': {
    desc: 'Lying hip extension with barbell. Glute activation for lockout.',
    yt: '',
  },
  'dl-farmerwalk': {
  ...
  'dl-row': {
    desc: 'Hinged barbell row. Upper back strength to prevent rounding during pulls.',
    yt: '',
  },
  'dl-latpulldown': {
  ...
  'dl-facepull': {
    desc: 'Cable rope pull to face. Rear delts and upper back posture work.',
    yt: '',
  },
  'dl-dbshrugs': {
  ...
  'dl-pullup': {
    desc: 'Overhand pull-up. Lat and upper back for maintaining position off the floor.',
    yt: '',
  },
